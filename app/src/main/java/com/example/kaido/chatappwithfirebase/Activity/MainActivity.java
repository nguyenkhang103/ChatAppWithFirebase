...
import com.example.kaido.chatappwithfirebase.Fragments.ChatFragment;
import com.example.kaido.chatappwithfirebase.Fragments.ProfileFragment;
import com.example.kaido.chatappwithfirebase.Fragments.UserFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TabLayout tabLayout = findViewById(R.id.tbLayout);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (unseen == 0){
                    ...
                    viewPagerAdapter.addFragment(new ChatFragment(), "("+unseen+") Chats ");
                }
